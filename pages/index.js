      ...
      <TwoColumnLayout>
        <Card id='learn-more'>
          <Box orientation='vertical' blockPadding='lg' inlinePadding='lg'>
            ...
            <text.p
              as='paragraph'
              text='GoDaddy Lighthouse is an insights platform powered by large language models. The platform allows users throughout the company to craft, manage and evaluate prompts against any text-based data.'
            />
            <Box inlineAlignChildren='start'>
              <Button
                ...
                text='Learn More'
                as='cta'
                href='https://godaddy-corp.atlassian.net/wiki/spaces/BI/pages/3343751333/GoDaddy+Lighthouse+-+an+Insights+Platform'
              />
            </Box>
          </Box>
        </Card>
        <Card id='get-started'>
          <Box orientation='vertical' blockPadding='lg' inlinePadding='lg'>
            ...
            <text.p
              as='paragraph'
              text='To get this party started, select a table from the list below'
            />
            <TableSelect />
          </Box>
        </Card>
