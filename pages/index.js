...
const TABLES = [
  {
    ...
    columns: ['css_score', 'repeat_contact_flag', 'customer_region_2', 'nps_score'],
...
export const IndexPage = () => {
  ...
  // useEffect(() => {
  //   // getTables().then(data => console.log(data));
  ...
  return (
    <><Head title='GoDaddy Lighthouse' route='prompt' />
      ...
      <Block className='lh-container lh-start'>
        <>
          <Block>
            <Logo />
          </Block>
        ...
        <>
          <Block>
            <Lockup>
              <text.h2 style={{ 'margin-bottom': '0px', 'padding-bottom': '0px' }} as='heading' text='Lighthouse' />
              <text.h4 as='title' text='Insights Platform' />
            ...
            <Button size='small' text='Learn More' design='primary' as='cta' />
          </Block>

        </>
      </Block>
      <div className='lh-container lh-start'>
        <Block>
          <Card id='panel' className='right-panel'>
            <Block>
