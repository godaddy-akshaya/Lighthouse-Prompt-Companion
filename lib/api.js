...
async function fetchData(endpoint, options = {}) {
    const res = await fetch(`${url_config[endpoint]}`, options);
    if (res.ok) {
...
module.exports = {
    getTables, getTableFilters, getTableRowCount, submitPromptJob, submitSummaryPromptJob, getStatus, cancelJob, getResultsByRunId
}
