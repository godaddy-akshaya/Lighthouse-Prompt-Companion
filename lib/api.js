...
const url_config = {
    ...
    view_summary: `https://6n03hx5990.execute-api.us-west-2.amazonaws.com/${enviro}`,
    submit_summary_job: `https://sfg8vqwjoj.execute-api.us-west-2.amazonaws.com/${enviro}`
};
// query params
// https://6n03hx5990.execute-api.us-west-2.amazonaws.com/dev?run_id=1
...
async function fetchData(endpoint, params = {}, options = {}) {
    const url = new URL(url_config[endpoint]);
...
async function getResultsByRunId(run_id) {
    ...
    const data = await fetchData('view_results', {}, options);
...
>>>>>>> parent of 1870cc1 (filter fixes)
...
module.exports = {
    getTables, getTableFilters, getTableRowCount, submitPromptJob, submitSummaryPromptJob, getStatus, cancelJob, getResultsByRunId, getSummaryResultsByRunId
}
