...
export async function columns$(column) {
...
export async function filterOptions$(filterOptions) {
...
export async function promptModel$(model, job, table, session, filterOptions) {
  const promptModel = {
